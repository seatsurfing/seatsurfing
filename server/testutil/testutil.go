...
func DropTestDB() {
	tables := []string{"auth_providers", "auth_states", "bookings", "spaces", "locations", "organizations_domains", "organizations", "users", "signups", "settings", "space_attributes", "groups", "users_groups", "auth_attempts", "users_preferences"}
...
func ClearTestDB() {
	tables := []string{"auth_providers", "auth_states", "auth_attempts", "bookings", "spaces", "locations", "organizations_domains", "organizations", "users", "users_preferences", "signups", "settings", "space_attributes", "groups", "users_groups"}
	for _, s := range tables {
