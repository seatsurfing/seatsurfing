...
DEV=$DEV CRYPT_KEY=$CRYPT_KEY STATIC_UI_PATH=$STATIC_UI_PATH PLUGINS_SUB_PATH=$PLUGINS_SUB_PATH SMTP_HOST=$SMTP_HOST SMTP_PORT=$SMTP_PORT go run `ls *.go | grep -v _test.go`
